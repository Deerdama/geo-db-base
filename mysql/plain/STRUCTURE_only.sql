...
--
-- Host: 127.0.0.1    Database: geo_plain
-- ------------------------------------------------------
...
CREATE TABLE `countries` (
  ...
  `world_region` varchar(30) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `border_countries` json DEFAULT NULL,
...
CREATE TABLE `languages` (
  ...
  `code_iso` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `code_iso_2` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `alt_iso` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
-- Dump completed on 2022-10-14 16:15:41
